...
/**
 * usePut Hook - PUT istekleri için
 * Veri güncelleme işlemleri için kullanılır
 *
 * @example
 * const { mutate, loading } = usePut<User, UpdateUserRequest>('/users/123');
...
/**
 * usePatch Hook - PATCH istekleri için
 * Kısmi veri güncelleme işlemleri için kullanılır
 */
